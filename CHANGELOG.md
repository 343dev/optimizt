...
- Changed summaries to report processed, skipped, and failed operations, plus the operations an interruption left undone. Work abandoned while shutting down counts as not started rather than failed.
